  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", ScrollList = (_dec = disallowMultiple(), _dec2 = menu("组件库/ScrollList"), _dec3 = requireComponent(ScrollView), _dec4 = executionOrder(-5000), _dec5 = property({
        ...
        serializable: false
      }), ccclass(_class = _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        function ScrollList() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "pageDistance", _descriptor4, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "cyclic", _descriptor5, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "lackCenter", _descriptor6, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "lackSlide", _descriptor7, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "frameByFrameRenderNum", _descriptor8, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "renderEvent", _descriptor9, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "selectedMode", _descriptor10, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "selectedEvent", _descriptor11, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "repeatEventSingle", _descriptor12, _assertThisInitialized(_this));
          ...
          _defineProperty(_assertThisInitialized(_this), "_actualNumItems", void 0);
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "canTouchCancel", _descriptor13, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "templateType", _descriptor14, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "pageChangeEvent", _descriptor15, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "animationEvent", _descriptor16, _assertThisInitialized(_this));
          ...
          _defineProperty(_assertThisInitialized(_this), "_mainPool", null);

          _defineProperty(_assertThisInitialized(_this), "_poolList", []);
          ...
          _defineProperty(_assertThisInitialized(_this), "_contentList", []);

          _defineProperty(_assertThisInitialized(_this), "_showAnimation", true);

          _initializerDefineProperty(_assertThisInitialized(_this), "_slideMode", _descriptor17, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "_virtual", _descriptor18, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "_updateRate", _descriptor19, _assertThisInitialized(_this));

          _defineProperty(_assertThisInitialized(_this), "_selectedId", -1);

          _initializerDefineProperty(_assertThisInitialized(_this), "_numItems", _descriptor20, _assertThisInitialized(_this));
        ...
        _proto.onDestroy = function onDestroy() {
          ...
          t._poolList.forEach(function (value) {
            value.clear();
          });
        };
        ...
        _proto._init = function _init() {
          ...
          var tmpNode = t.templateType === TemplateType.PREFAB ? instantiate(t.tmpPrefab) : t.tmpNode;

          if (!EDITOR && isValid(tmpNode)) {
            var listItem = tmpNode.getComponent(_crd && ScrollListItem === void 0 ? (_reportPossibleCrUseOfScrollListItem({
              error: Error()
            }), ScrollListItem) : ScrollListItem);
            this.contentLayerType = listItem.contentLayerType;

            if (this.contentLayerType === LayerType.SLICE) {
              for (var i = 0; i < listItem.layerNodeList.length; i++) {
                var childContent = new Node();
                childContent.layer = Layers.Enum.UI_2D;
                var contentTF = this.content.getComponent(UITransform);
                var childtf = childContent.addComponent(UITransform);
        ...
        _proto.setTemplateItem = function setTemplateItem(item) {
          ...
          var com = item.getComponent(_crd && ScrollListItem === void 0 ? (_reportPossibleCrUseOfScrollListItem({
            error: Error()
          }), ScrollListItem) : ScrollListItem);
          var remove = false;
        ...
        _proto._onScrolling = function _onScrolling(ev) {
          ...
          if (this.contentLayerType === LayerType.SLICE) {
            this._contentList.forEach(function (content) {
              content.position = _this2.content.position;
            });
          }
        ...
        _proto._onTouchStart = function _onTouchStart(ev, captureListeners) {
          ...
          if (!isMe) {
            ...
            while (itemNode._listId === 0 && itemNode.parent) {
        ...
        _proto._createOrUpdateItem = function _createOrUpdateItem(data, animate) {
          var _this3 = this;
          ...
          if (!item) {
            //如果不存在
            var canGet = this._mainPool.size() > 0;

            if (canGet) {
              item = this._mainPool.get();

              this._poolList.forEach(function (pool, index) {
              ...
              if (!isValid(item)) {
                ...
                var component = item.getComponent(_crd && ScrollListItem === void 0 ? (_reportPossibleCrUseOfScrollListItem({
                  error: Error()
                }), ScrollListItem) : ScrollListItem);
                component.layerNodeList.forEach(function (node, index) {
              ...
              var _component = item.getComponent(_crd && ScrollListItem === void 0 ? (_reportPossibleCrUseOfScrollListItem({
                error: Error()
              }), ScrollListItem) : ScrollListItem);

              _component.layerNodeList.forEach(function (node, index) {
                node.posV3 = node.position.clone();
                elementList.push(node);
              });
            }
            ...
            var vec3Point = new Vec3(data.x, data.y, 0);
            item.setPosition(vec3Point);
            elementList.forEach(function (element, index) {
              var pos = element.posV3.clone().add(vec3Point);
            ...
            elementList.forEach(function (element, index) {
              element.parent = _this3._contentList[index];
            });
            ...
            var listItem = item.getComponent(_crd && ScrollListItem === void 0 ? (_reportPossibleCrUseOfScrollListItem({
              error: Error()
            }), ScrollListItem) : ScrollListItem);
        ...
        _proto._createOrUpdateItem2 = function _createOrUpdateItem2(listId) {
          ...
          if (!item) {
            ...
            elementList.forEach(function (element, index) {
              ...
              element.parent = _this4._contentList[index];
            });
        ...
        _proto.getItemByListId = function getItemByListId(listId, content) {
          content = content || this.content;

          if (content) {
            for (var n = content.children.length - 1; n >= 0; n--) {
              var item = content.children[n];
        ...
        _proto._getOutsideItem = function _getOutsideItem(content) {
          content = content || this.content;
          var item;
          var result = [];
        ...
        _proto._delRedundantItem = function _delRedundantItem() {
          ...
          if (this._virtual) {
            ...
            this._contentList.forEach(function (content, index) {
              var arr = _this5._getOutsideItem(content);

              for (var _n3 = arr.length - 1; _n3 >= 0; _n3--) {
                var _item = arr[_n3];
                if (_this5._scrollItem && _item._listId === _this5._scrollItem._listId) continue;

                _this5._poolList[index].put(_item);
              }
            });
          } else {
            ...
            this._contentList.forEach(function (content, index) {
              while (content.children.length > _this5._numItems) {
                _this5._delSingleItem(content.children[content.children.length - 1]);
              }
            });
          }
        } //删除单个Item
        ...
        _proto.aniDelItem = function aniDelItem(listId, callFunc, aniType) {
          ...
          listItem.showAni(aniType, function () {
            ...
            for (var _n4 = newId !== 0 ? newId : curLastId; _n4 >= listId + 1; _n4--) {
        ...
        _proto.scrollTo = function scrollTo(listId, timeInSecond, offset, overStress) {
          ...
          var runScroll = Math.abs((t._scrollPos !== 0 ? t._scrollPos : viewPos) - comparePos) > 0.5; // cc.log(runScroll, t._scrollPos, viewPos, comparePos)
              ...
              case SelectedType.MULT:
                {
                  ...
                  var _listItem = item.getComponent(_crd && ScrollListItem === void 0 ? (_reportPossibleCrUseOfScrollListItem({
                    error: Error()
                  }), ScrollListItem) : ScrollListItem);
          ...
          set: function set(val) {
            ...
            if (t._virtual) {
              ...
              if (t.frameByFrameRenderNum > 0) {
                ...
                for (var _n5 = 0; _n5 < t._numItems; _n5++) {
                  t._createOrUpdateItem2(_n5);
                }
        ...
        return ScrollList;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "contentLayerType", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
