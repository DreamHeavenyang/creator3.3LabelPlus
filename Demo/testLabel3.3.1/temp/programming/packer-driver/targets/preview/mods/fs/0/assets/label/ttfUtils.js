System.register(["__unresolved_0", "cc"], function (_export, _context2) {
  ...
  var _reporterNs, _cclegacy, BASELINE_RATIO, Color, director, dynamicAtlasManager, fragmentText, getBaselineOffset, HorizontalTextAlignment, Label, LabelOutline, LabelShadow, logID, Rect, safeMeasureText, Size, SpriteFrame, Vec2, VerticalTextAlignment, _crd, Overflow, MAX_SIZE, _BASELINE_OFFSET, _invisibleAlpha, _context, _canvas, _texture, _fontDesc, _string, _fontSize, _drawFontsize, _splitStrings, _canvasSize, _lineHeight, _hAlign, _vAlign, _color, _alpha, _fontFamily, _overflow, _isWrapText, _outlineComp, _outlineColor, _shadowComp, _shadowColor, _canvasPadding, _contentSizeExtend, _nodeContentSize, _startPosition, _drawUnderlinePos, _drawUnderlineWidth, _underlineThickness, _isBold, _isItalic, _isUnderline, Alignment, ttfUtils, BlendFactor;
  ...
  function _reportPossibleCrUseOfISharedLabelData(extras) {
    _reporterNs.report("ISharedLabelData", "./font-utils", _context2.meta, extras);
  }

  function _reportPossibleCrUseOfLetterRenderTexture(extras) {
    _reporterNs.report("LetterRenderTexture", "./font-utils", _context2.meta, extras);
  }

  _export("BlendFactor", void 0);
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "213cbseZZRPtJmEqPx1c0xS", "ttfUtils", undefined);
      ...
      _export("ttfUtils", ttfUtils = {
        ...
        _updateTexture: function _updateTexture(comp) {
          ...
          if (_outlineComp) {
            _context.fillStyle = "rgba(" + _outlineColor.r + ", " + _outlineColor.g + ", " + _outlineColor.b + ", " + _invisibleAlpha + ")"; // Notice: fillRect twice will not effect

            _context.fillRect(0, 0, _canvas.width, _canvas.height); // to keep the one model same as before
...
//# sourceMappingURL=ttfUtils.js.map